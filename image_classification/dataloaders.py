...
def get_pytorch_train_loader(data_path, image_size,batch_size, num_classes, one_hot, workers=5, _worker_init_fn=None, fp16=False,padding = 32,):
    traindir = os.path.join(data_path, 'train')
...
def get_pytorch_val_loader(data_path, image_size, batch_size, num_classes, one_hot,  workers=5, _worker_init_fn=None, fp16=False,padding = 32,):
    valdir = os.path.join(data_path, 'val')
    val_dataset = datasets.ImageFolder(
            valdir, transforms.Compose([
                transforms.Resize(image_size+padding),
